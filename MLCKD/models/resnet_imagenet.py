...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50_img', 'resnet101',
...
def resnet50_img(pretrained=False, progress=True, **kwargs):
...
def wide_resnet40_2(pretrained=False, progress=True, **kwargs):
    kwargs['width_per_group'] = 64 * 2
    return _resnet('wide_resnet40_2', BasicBlock, [6, 6, 6,6], pretrained, progress, 
                   **kwargs)
